package com.noteit.config.auth;

import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.auth.FirebaseAuthException;
import com.google.firebase.auth.FirebaseToken;
import com.noteit.config.auth.models.Credentials;
import com.noteit.config.auth.models.SecurityProperties;
import com.noteit.config.auth.utils.CookieUtils;
...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    private User firebaseTokenToUserDto(FirebaseToken decodedToken) {
        ...
        if (decodedToken != null) {
            user = new User();
            user.setUserId(Long.valueOf(decodedToken.getUid()));
